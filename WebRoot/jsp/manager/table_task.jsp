								...
								<tbody>
									...
									<c:forEach items="${ptasks}" var="ptask">
										<tr>
											...
											<td><a href="children_table.do">其他负责人</a></td>
										 	<td>
											<div class="btn-group">
												<a class="btn btn-primary" href="insert.do?1=1" ><i class="icon_plus_alt2"></i></a>  
												<a class="btn btn-success" href="updateTask.do?id=${ptask.id}" data-toggle="modal"><i class="icon_pencil-edit_alt"></i></a> 
