...
<div class="row">
                  ...
                  <strong>注意!</strong> 采购任务进度全部完成之后，可提交给仓库管理员。对应的生产任务进入待采购入库阶段。采购入库后，采购任务无法操作。
                </div>
							...
							<table class="table table-striped table-advance table-hover">
								<tbody>
									...
									<c:forEach items="${otasks}" var="otask">
										...
										<td><a href="table_material.do?ptaskid=${otask.ptask.id}"><c:out value="${otask.ptask.id}" /></a></td>
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li><a href="updateTaskStatus.do?id=${otask.id}&status=4">完成</a>
											...
											<td>
											<div class="btn-group">
												<a class="btn btn-success" href="submitForPur.do?ptaskid=${otask.ptask.id }" > 提交</a>  
												<a class="btn btn-danger" href="delTask2.do?id=${otask.id }" > 删除</a>  
												</div>
											</td> 
										</tr>
