			            ...
			            <div class="col-lg-10">
                         ...
                         <div class="form-group ">
	                      ...
	                      <div class="col-lg-10">
            			     ...
            			     <div class="form-group ">
	                      <label for="cname" class="control-label col-lg-2">任务类型<span class="required">*</span></label>
	                      <div class="col-lg-10">
	                         ...
	                         <span class="help-block">采购任务请选择采购。</span>
	                      </div>
	                    </div>
	                      ...
	                      <div class="col-lg-10">
							...
							<span class="help-block">产品类型任务请选择用料类型。</span>
